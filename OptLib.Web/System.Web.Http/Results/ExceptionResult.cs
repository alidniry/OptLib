...
namespace System.Web.Http.Results
{
    ...
    /// performs content negotiation on an <see cref="HttpErrorNegareh"/> based on an <see cref="Exception"/>.
    /// </summary>
    public class ExceptionResultNegareh : IHttpActionResult
    {
        private readonly Exception _exception;
        private readonly IDependencyProvider _dependencies;

        /// <summary>Initializes a new instance of the <see cref="ExceptionResultNegareh"/> class.</summary>
        ...
        public ExceptionResultNegareh(Exception exception, bool includeErrorDetail, IContentNegotiator contentNegotiator,
        ...
        public ExceptionResultNegareh(Exception exception, ApiController controller)
            : this(exception, new ApiControllerDependencyProvider(controller))
        {
        }

        private ExceptionResultNegareh(Exception exception, IDependencyProvider dependencies)
        {
            if (exception == null)
            {
        ...
        {
            HttpErrorNegareh error = new HttpErrorNegareh(_exception, _dependencies.IncludeErrorDetail);
            return NegotiatedContentResultNegareh<HttpErrorNegareh>.Execute(HttpStatusCode.InternalServerError, error,
