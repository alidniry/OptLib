...
namespace System.Web.Http.Results
{
    ...
    public class NegotiatedContentResultNegareh<T> : IHttpActionResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NegotiatedContentResultNegareh{T}"/> class with the values provided.
        /// </summary>
        ...
        public NegotiatedContentResultNegareh(HttpStatusCode statusCode, T content, IContentNegotiator contentNegotiator,
        ...
        public NegotiatedContentResultNegareh(HttpStatusCode statusCode, T content, ApiController controller)
            : this(statusCode, content, new ApiControllerDependencyProvider(controller))
        {
        }

        private NegotiatedContentResultNegareh(HttpStatusCode statusCode, T content, IDependencyProvider dependencies)
        {
