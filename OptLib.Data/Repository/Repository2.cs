...
namespace ABMLib.DAL.LocalDB
{
    ...
    public class Repository2<TDbCtx, TEntity, TEntitylog> : IRepository2<TDbCtx, TEntity, TEntitylog>
        ...
        where TEntitylog : class, new()
    {
        ...
        public int MemberId { get; private set; }
        public UnitOfWork2 UFW { get; set; }
        public Repository2(/*IDbContext*/IDbContext2 context, IDbContext2 contextLog, UnitOfWork2 ufw, int mid)
        {
            this.Context = context;
