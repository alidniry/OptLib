...
namespace OptLib.Data.Base
{
    ...
    public abstract class HEntityBaseIdDescription<TKey>
        : HEntityBaseId<TKey>
    {
        #region Configuration
        public class Configuration<TEntityType>
            : HEntityBaseId<TKey>.Configuration<TEntityType>
            where TEntityType : HEntityBaseIdDescription<TKey>
        {
        ...
        /// </summary>
        public HEntityBaseIdDescription()
            : base()
        {

        }
        public HEntityBaseIdDescription(_History history)
            : base(history)
        {
        }
        /// <summary>
        ...
        public HEntityBaseIdDescription(TKey id, _History history)
            : base(id, history)
        {
