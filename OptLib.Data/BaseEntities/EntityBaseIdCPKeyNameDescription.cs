...
namespace OptLib.Data.Base
{
    ...
    public abstract class EntityBaseIdCPKeyNameDescription<TKey>
        : EntityBaseIdCPKeyName<TKey>, IEntityBaseIdCPKeyNameDescription<TKey>
    {
        ...
        /// </summary>
        public EntityBaseIdCPKeyNameDescription()
            : base()
        {
        }
        /// <summary>
        ...
        public EntityBaseIdCPKeyNameDescription(string name)
            : base(name)
        {
        }
        /// <summary>
        ...
        /// <param name="name">The name.</param>
        public EntityBaseIdCPKeyNameDescription(TKey id, long cpKey, string name)
            : base(id, cpKey, name)
        {
        }
        #endregion
