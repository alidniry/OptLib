...
namespace OptLib.Data.Base
{
    ...
    /// Id, Name
    /// </summary>
    public abstract class HEntityIdNameDescription<TKey>
        : HEntityIdName<TKey>
    {
        #region Configuration
        public class Configuration<TEntityType>
            : HEntityId<TKey>.Configuration<TEntityType>
            where TEntityType : HEntityIdName<TKey>
        {
        ...
        public HEntityIdNameDescription(string name, _History history)
            : base(name, history)
        {
        }
        /// <summary>
        ...
        /// <param name="name">The name.</param>
        public HEntityIdNameDescription(TKey id, string name, _History history)
