...
namespace OptLib.Data.Base
{
    ...
    /// Id, Name
    /// </summary>
    public abstract class HEntityIdDescription<TKey>
        : HEntityId<TKey>
    {
        #region Configuration
        public class Configuration<TEntityType>
            : HEntityId<TKey>.Configuration<TEntityType>
            where TEntityType : HEntityIdDescription<TKey>
        {
        ...
        public HEntityIdDescription(_History history)
           : base(history)
        {
        }
        /// <summary>
        ...
        public HEntityIdDescription(TKey id, _History history)
            : base(id, history)
        {
        }
        #endregion
