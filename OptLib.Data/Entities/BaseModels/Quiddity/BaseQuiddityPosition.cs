...
namespace OptLib.Data.BaseModels
{
    ...
    /// ماهیت موقعیت
    /// </summary>
    public abstract partial class BaseQuiddityPosition<TModelQuiddity, TModelQuiddityAction, TModelQuiddityActor, TModelQuiddityAllocationResource, TModelQuiddityConnection, TModelQuiddityObject, TModelQuiddityPosition, TModelQuiddityPrice, TModelQuiddityRelation, TModelQuiddityService>
        : EntityId<ulong>,
        ...
        where TModelQuiddityService : BaseQuiddityService<TModelQuiddity, TModelQuiddityAction, TModelQuiddityActor, TModelQuiddityAllocationResource, TModelQuiddityConnection, TModelQuiddityObject, TModelQuiddityPosition, TModelQuiddityPrice, TModelQuiddityRelation, TModelQuiddityService>
    {
        ...
        public class Configuration
            : EntityId<ulong>.Configuration<TModelQuiddityPosition>
        {
            public Configuration()
            {
                ...
                HasRequired(c => c.Quiddity)
                   .WithOptional(c => c.QuiddityPosition)
        ...
        public BaseQuiddityPosition(ulong id)
            : base(id)
        {
