...
namespace OptLib.Data.BaseModels
{
    ...
    /// ماهیت قیمتها
    /// </summary>
    public abstract partial class BaseQuiddityPrice<TModelQuiddity, TModelQuiddityAction, TModelQuiddityActor, TModelQuiddityAllocationResource, TModelQuiddityConnection, TModelQuiddityObject, TModelQuiddityPosition, TModelQuiddityPrice, TModelQuiddityRelation, TModelQuiddityService>
        : EntityId<ulong>,
        ...
        where TModelQuiddityService : BaseQuiddityService<TModelQuiddity, TModelQuiddityAction, TModelQuiddityActor, TModelQuiddityAllocationResource, TModelQuiddityConnection, TModelQuiddityObject, TModelQuiddityPosition, TModelQuiddityPrice, TModelQuiddityRelation, TModelQuiddityService>
    {
        ...
        public class Configuration
            : EntityId<ulong>.Configuration<TModelQuiddityPrice>
        {
            public Configuration()
            {
                ...
                HasRequired(c => c.Quiddity)
                   .WithOptional(c => c.QuiddityPrice)
        ...
        public BaseQuiddityPrice(ulong id)
            : base(id)
        {
