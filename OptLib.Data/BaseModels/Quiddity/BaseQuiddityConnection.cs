...
namespace OptLib.Data.BaseModels
{
    ...
    /// ماهیت اتصال تماس
    /// </summary>
    public abstract partial class BaseQuiddityConnection<TKey>
        : HEntityBaseIdCPKey<TKey>
    {
        #region Configuration
        public class Configuration<TEntityType>
            : HEntityBaseIdCPKey<TKey>.Configuration<TEntityType>
            where TEntityType : BaseQuiddityConnection<TKey>
        {
        ...
        public BaseQuiddityConnection(TKey id, long cpKey, _History history)
