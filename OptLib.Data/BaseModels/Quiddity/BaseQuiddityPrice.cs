...
namespace OptLib.Data.BaseModels
{
    ...
    /// ماهیت قیمتها
    /// </summary>
    public abstract partial class BaseQuiddityPrice<TKey>
        : HEntityBaseIdCPKey<TKey>
    {
        #region Configuration
        public class Configuration<TEntityType>
            : HEntityBaseIdCPKey<TKey>.Configuration<TEntityType>
            where TEntityType : BaseQuiddityPrice<TKey>
        {
        ...
        public BaseQuiddityPrice(TKey id, long cpKey, _History history)
