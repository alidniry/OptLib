...
namespace OptLib.Data.BaseModels
{
    ...
    /// ماهیت اشیاء
    /// </summary>
    public abstract partial class BaseQuiddityObject<TKey>
        : HEntityBaseIdCPKey<TKey>
    {
        #region Configuration
        public class Configuration<TEntityType>
            : HEntityBaseIdCPKey<TKey>.Configuration<TEntityType>
            where TEntityType : BaseQuiddityObject<TKey>
        {
        ...
        public BaseQuiddityObject(TKey id, long cpKey, _History history)
