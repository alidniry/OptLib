...
namespace OptLib.Data.BaseModels
{
    ...
    /// ماهیت تخصیص منابع
    /// </summary>
    public abstract partial class BaseQuiddityAllocationResource<TKey>
        : HEntityBaseIdCPKey<TKey>
    {
        #region Configuration
        public class Configuration<TEntityType>
            : HEntityBaseIdCPKey<TKey>.Configuration<TEntityType>
            where TEntityType : BaseQuiddityAllocationResource<TKey>
        {
        ...
        public BaseQuiddityAllocationResource(TKey id, long cpKey, _History history)
