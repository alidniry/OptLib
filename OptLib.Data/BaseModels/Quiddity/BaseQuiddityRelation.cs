...
namespace OptLib.Data.BaseModels
{
    ...
    /// </summary>
    public abstract partial class BaseQuiddityRelation<TKey>
        : HEntityBaseIdCPKey<TKey>
    {
        #region Configuration
        public class Configuration<TEntityType>
            : HEntityBaseIdCPKey<TKey>.Configuration<TEntityType>
            where TEntityType : BaseQuiddityRelation<TKey>
        {
        ...
        public BaseQuiddityRelation(TKey id, long cpKey, _History history)
