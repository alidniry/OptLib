...
namespace OptLib.Data.BaseModels
{
    ...
    /// ماهیت موقعیت
    /// </summary>
    public abstract partial class BaseQuiddityPosition<TKey>
        : HEntityBaseIdCPKey<TKey>
    {
        #region Configuration
        public class Configuration<TEntityType>
            : HEntityBaseIdCPKey<TKey>.Configuration<TEntityType>
            where TEntityType : BaseQuiddityPosition<TKey>
        {
        ...
        public BaseQuiddityPosition(TKey id, long cpKey, _History history)
